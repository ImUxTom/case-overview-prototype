...
require('./routes/case--mark-first-hearing-happened')(router)
require('./routes/case--record-first-hearing-outcome')(router)
require('./routes/case--add-ptph-hearing')(router)
require('./routes/case--mark-ptph-happened')(router)
require('./routes/case--record-ptph-hearing-outcome')(router)
require('./routes/case--mark-trial-preparation-complete')(router)
require('./routes/case--mark-trial-concluded')(router)
require('./routes/case--record-trial-outcome')(router)
require('./routes/case--record-sentence')(router)
